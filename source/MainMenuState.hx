...
{
	public static var plusEngineVersion:String = '1.0'; //This is also used for Discord RPC
...
// Story Mode
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Plus Engine v" + psychEngineVersion, 12);
